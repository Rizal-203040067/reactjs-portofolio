...
export default function Platform() {
  return (
    <section className="flex flex-col items-center w-full bg-black opacity-40 mt-8 mb-12">
      <div className="max-w-screen-xl  mx-auto py-10 px-4 md:px-16">
        <div className="flex flex-col md:flex-row space-x-0 lg:space-x-10 items-center text-justify lg:justify-between">
          <div className="flex flex-row items-center">
            <img
              ...
              alt=""
            />
            <h1 className="text-4xl ml-2">Shutterstock</h1>
          </div>
          <div className="flex flex-row items-center">
            <img
              className="h-20"
              ...
              alt=""
            />
            <h1 className="text-4xl ml-2">Linkedln</h1>
          </div>
          <div className="flex flex-row items-center">
            <img
              className="h-20"
              ...
              alt=""
            />
            <h1 className="text-4xl ml-2">Github</h1>
          </div>
        </div>
      </div>
    </section>
